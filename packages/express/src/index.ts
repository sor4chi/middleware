...
// ref: https://github.com/honojs/node-server/blob/v1.0.0/src/listener.ts
// TODO: offer to export node-webstd proxy handler in @hono/node-server and use it here

export function hono(app: Hono) {
	const fetchCallback = app.fetch;
	return async (incoming: ERequest, outgoing: EResponse) => {
